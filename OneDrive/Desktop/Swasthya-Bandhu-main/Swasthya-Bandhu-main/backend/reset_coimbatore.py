...
from entity.models import Base, Doctor, User, Appointment, ChatSession, HealthRiskScore, FamilyMember, DoctorSlot, AuditLog, OutbreakAlert
...
def reset_database():
    ...
    print(f"✅ Seeded 11 doctors (10 approved + 1 pending)")
    print("✅ All doctors focused on Coimbatore (lat: 11.0081, lng: 76.9650)")
    print("✅ Ready for Leaflet mapping implementation")
